...
INSERT IGNORE INTO `#__virtuemart_categories_XLANG` (`virtuemart_category_id`, `category_name`, `category_description`, `metadesc`, `metakey`, `customtitle`, `slug`) VALUES
  (2, 'Produit modèle', '<p><span style="background-color: #fcdb73; text-align: center; padding: 5px 40px;">Exemple d''utilisation du modèle de produit. Pour des raisons de showcase le MODELE n''est PAS dépublié.</span></p>', '', '', '', 'produit-modèle'),
(3, 'Pagination', '<p>Utiliser cette catégorie pour tester l''ordre des produits. Tri par nom, SKU (REF), fournisseur (d''autres disponibles dans vmconfig &gt; Tri des produits)<br /><br /></p>&#13;&#10;<p style="background-color: #fcdb73; text-align: center; padding: 5px 40px;"><strong>Conseil :</strong> Il y a trois modèles HGD#0, CEG#0, FAC#0. Les deux derniers chiffres représentent l''ordre de tri.</p>', '', '', '', 'pagination'),
(4, 'Couvre-chefs', '', '', '', '', 'couvre-chefs'),
(7, 'Vêtements', '', '', '', '', 'vetements'),
(8, 'Homme', '<p>Example de sous-catégorie. <br />Sélectionnez la catégorie prioritaire dans l''administration VM &gt; <em>Catégories de produits</em> &gt; <strong>Votre catégorie</strong> dans la section <em>Details &gt; </em> <em> Classement des catégories </em></p>&#13;&#10;<p> </p>', '', '', '', 'homme'),
(9, 'Femme', '<p>Example de sous-catégorie. <br />Sélectionnez la catégorie prioritaire dans l''administration VM &gt; <em>Catégories de produits</em> &gt; <strong>Votre catégorie</strong> dans la section <em>Details &gt; </em> <em> Classement des catégories </em></p>&#13;&#10;<p><em> </em></p>', '', '', '', 'femme'),
(11, 'Produits avec variantes', '<p>Des variantes de produits en fonction des champs personnalisés saisis par l''utilisateur.</p>', '', '', '', 'produits-avec-variantes'),
(12, 'Produits avec attributs', '<p><span style="background-color: #fcdb73; text-align: center; padding: 5px 40px;">Des produits utilisant des champs personnalisés en tant qu''attribut.</span></p>', '', '', '', 'produits-avec-attributs');
...
INSERT IGNORE INTO `#__virtuemart_manufacturercategories_XLANG` (`virtuemart_manufacturercategories_id`, `mf_category_name`, `mf_category_desc`, `slug`) VALUES
	(1, 'defaut', 'Il s''agit de la catégorie fournisseur par défaut.', 'defaut');
...
INSERT IGNORE INTO `#__virtuemart_manufacturers_XLANG` (`virtuemart_manufacturer_id`, `mf_name`, `mf_email`, `mf_desc`, `mf_url`, `slug`) VALUES
	(1, 'Fournisseur', 'manufacturer@example.org', '<p>Un exemple d''un fournisseur</p>', 'http://virtuemart.net', 'fournisseur'),
(2, 'Defaut', 'example@manufacturer.net', '<p>Fournisseur par défaut</p>', 'http://virtuemart.net', 'defaut'),
(3, 'Producteur', 'info@producer.com', '<p>Un exemple d''un autre fournisseur.</p>', 'http://virtuemart.net', 'producteur');
...
(13, 'MODELE Racine', 'racine', '', '<p>Ce produit est dérivé d''un modèle pour d''autres produits. C''est un produit parent qui possède plusieurs produits enfant. <br />Vous pouvez définir plusieurs paramètres (contenu, Champs personnalisés) Pour le produit parent. Les enfants de ce parent hériteront automatiquement des mêmes paramètres que le parent sauf si vous écrasez les paramètres.<br /><br /></p>\n<p>Dans ce cas, le prix du produit est défini dans le modèle.</p>\n<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>\n<p>At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p>\n<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.   <br /><br /></p>');
...
INSERT IGNORE INTO `#__virtuemart_products_XLANG` (`virtuemart_product_id`, `product_name`, `slug`, `product_s_desc`, `product_desc`) VALUES
	(163, 'Produit MODELE avec attribut', 'modele-produit-attributes', '', 'produit'),
(164, 'Produit par défaut', 'default-produit', '', ''),
(165, 'Produit gratuit', 'produit-gratuit', 'Ceci est un produit gratuit', '<p>Ce produit montre comment un produit gratuit est paramétré. L''acheteur peut acheter sans être facturé. Dans tous les cas, l''acheteur doit commander.</p>\r\n<p>Cela peut être utilisé, par exemple, si vous voulez offrir des catalogues ou des échantillons de produit.</p>'),
(166, 'Chaine & liste, éditeur', 'chaine-liste,-éditeur', 'Produit par défaut avec les champs chaîne de caractère & éditeur. ', '<p>Note: Cet exemple de chaîne n''est pas un attribut de panier. Si vous souhaitez afficher le détail de la chaîne dans le panier, activer l''attribut panier dans le protoype personnalisé.</p>'),
(167, 'Images & liste', 'images-liste', 'Démonstration champ personnalisé image.', '<p>Utiliser le champ personnalisé pour afficher une image ou une liste d''images dans la position souhaitée dans la mise en page . <br /><br />Le champ personnalisé image permet d''utiliser n''importe laquelle de vos images médias, alors que la liste d''images fournit une présélection basée sur liste dans le prototype du champ personnalisé.<br />Voir pour plus de détails : VirtueMart &gt; Champs personnalisés &gt; Liste d''image</p>'),
(168, 'Plusieurs prix par quantité', 'plusieurs-prix-par-quantité', 'Gammes de prix en fonction de la quantité de produits.', '<p>Gammes de prix selon la quantité de produit. Tester les changements de prix suivant les valeurs ci-dessous<br /><br />100€ 1-5 pcs</p>\r\n<p>80€ 6-10 pcs</p>\r\n<p>70€ 11- pcs</p>'),
(169, 'Plusieurs prix par groupe client', 'plusieurs-prix-par-groupe', 'Prix différent selon groupe d''acheteurs.', '<p>Votre groupe de client fait varier votre prix. Connectez vous pour visualiser<br /><br />100€ Invité</p>\r\n<p>80€ Enregistré</p>\r\n<p>50€ Membre OR</p>');
...
INSERT IGNORE INTO `#__virtuemart_products_XLANG` (`virtuemart_product_id`, `product_name`, `slug`, `product_s_desc`, `product_desc`) VALUES
	(200, 'MODELE Basique', 'modele-basique', 'Démonstration de l''utilisation d''un modèle.', '<p>Ce produit est utilisé comme modèle pour les autres produits. C''est un produit parent et a plusieurs produits enfants. <br />Vous pouvez définir plusieurs paramètres (contenu, champs personnalisés) pour le produit parent. Les enfants de ce parent en hériteront automatiquement des mêmes paramètres principaux sauf si vous écrasez ces paramètres en surchargeant.<br /><br /></p>\r\n<p>Dans ce cas le prix du produit prix est paramétré dans le modèle.</p>'),
(201, 'Enfant simple', 'enfant-simple', 'Il s''agit d''un enfant de base du produit MODELE.', '<p>Voici un enfant de base du produit MODELE . Vous voyez les paramètres hérités, seule la description du produit est remplacée.</p>'),
(202, 'Surcharge du prix de base', 'surcharge-du-prix-de-base', 'Voici un enfant de base du produit modèle. Vous visualisez les paramètres hérités.', '<p>Voici un enfant de base du produit MODELE. Vous apercevez les paramètres hérités. <br />Sont surchargés les réglages/contenus suivants :<br />- desc produit <br />- prix produit </p>'),
(203, 'Surcharge multiple du modèle basique', 'surcharge-multiple-du-modèle-basique', 'Courte description de surcharges multiples.', '<p>Voici un enfant du produit MODELE. La plupart des paramètres hérités sont surchargés: <br />- Courte desc<br />- desc produit <br />- prix produit<br />- Images produit <br />- Dimension produit et poids (Unités dans la boite)<br />- Champs personnalisés</p>'),
(204, 'MODELE avancé', 'modele-avancé', 'Démonstration de l''utilisation du modèle avancé.', '<p>Ce produit est utilisé comme modèle pour d''autres produits. C''est un produit parent et a plusieurs produits enfants. <br />Vous pouvez définir plusieurs paramètres (contenu, champs personnalisés) pour le produit parent. Les enfants de ce parent en hériteront automatiquement des mêmes paramètres principaux sauf si vous écrasez ces paramètres en surchargeant.</p>\r\n<p>Un des gros avantages est la possibilité de contrôler les stocks.</p>'),
(205, 'Enfant avancé', 'enfant-avancé', '', '<p>Voici un enfant de base du produit MODELE. Vous apercevez les paramètres hérités, seule la description du produit est surchargée.</p>'),
(206, 'Surcharge avancées du prix', 'surcharge-avancées-du-prix', '', '<p>Voici un enfant avancé du modèle avancé. Vous apercevez les paramètres hérités. <br />Sont surchargés les réglages/contenus suivants :<br />- desc produit <br />- prix produit </p>'),
(207, 'Surcharges avancées multiples', 'surcharges-avancées-multiples', 'Surcharges multiples avancées', '<p>Voici un enfant du produit MODELE. La plupart des paramètres hérités sont surchargés: <br />- Description courte<br />- Description du produit<br />- Prix du produit<br />- Images du produit <br />- Dimension produit et poids (Unités dans la boite)<br />- Champs personnalisés</p>');
...
INSERT IGNORE INTO `#__virtuemart_products_XLANG` (`virtuemart_product_id`, `product_name`, `slug`, `product_s_desc`, `product_desc`) VALUES
  (170, 'PATTERN Product variants', 'pattern-product-variants', '', ''),
	(171, 'Champ personnalisé Chaîne', 'champ-personnalisé-chaîne', '', ''),
(172, 'Variante enfant générique', 'variante-enfant-générique', 'Produit générique par défaut  avec variante enfant et variante panier.', '<p>Démonstration pour présenter la combinaison du prix du produit, prix de la variante enfant, et prix de la variante panier:<br /><br />variante enfant -&gt; produit authentique totalement surchargeable, gestion de stock par variante</p>\r\n<p>variante panier -&gt; variante facile à utiliser, ajouter des prix, aucun contrôle des stocks</p>'),
(173, 'Variante enfant générique A', 'generic-enfant-variante-a', '', ''),
(174, 'Variante enfant générique B', 'generic-enfant-variante-b', 'Produit générique par défaut  avec variante enfant et variante panier.', '<p>Ce produit est une démonstration pour présenter la combinaison du prix produit, prix variante enfant, et prix variante panier.<br /><br />variante panier -&gt; facile à utiliser, prix additionnel (+0.50€) aucune gestion de stock de variante</p>\n<p><br />variante enfant -&gt; produit authentique complètement surchargeable en tant que variante</p>'),
(175, 'Variante enfant générique C', 'generic-enfant-variante-c', 'Produit générique par défaut  avec variante enfant et variante panier.', '<p>Ce produit est une démonstration pour présenter la combinaison du prix produit, prix variante enfant, et prix variante panier.<br /><br />variante panier -&gt; facile à utiliser, prix additionnel (+0.50€) aucune gestion de stock de variante</p>\n<p><br />enfant variante -&gt; produit authentique complètement surchargeable en tant que variante</p>'),
(176, 'Variante champ personnalisé image', 'variante-champ-personnalisé-image', 'Produit avec variante image ', '<p>Variante</p>');
...
INSERT IGNORE INTO `#__virtuemart_products_XLANG` (`virtuemart_product_id`, `product_name`, `slug`, `product_s_desc`, `product_desc`) VALUES
 (153, 'MODELE Vêtement', 'modele-vêtement', '', ''),
(154, 'Chemise avec cravate', 'chemise-avec-cravate', 'Des plumes fines font de beaux oiseaux – il est temps de se prendre au sérieux.', '<p>Rajeunissez avec la véritable chemise VM.</p>'),
(155, 'T-Shirt classique bleu', 't-shirt-classique-blue', 'Camarade de votre Temps libre & Loisirs 360°.', '<p>La première chemise VM imprimée disponible – l''unique ! - la vertu. Profitez de l''offre de lancement </p>'),
(156, 'Pull Fermeture Éclair', 'pull-fermeture-éclair', 'Votre ami pour la saison d''hiver', ''),
(157, 'H20 Veste', 'h20-veste', 'Une pluie torrentielle? Froid? - Gardez-vous au sec et au chaud.', ''),
(158, 'Jupe « Knock-Rock »', 'jupe-knock-rock', 'Modèle traditionnel redessiné. emblème VM convenablement mis en évidence', ''),
(159, 'Couvre-chef MODELE', 'modele-headpiece', '', ''),
(160, 'Casque de sécurité', 'casque-de-sécurité', 'Protection Masterclass, votre sécurité quotidienne.', ''),
(161, 'Casquette "Baseball"', 'casquette-baseball', 'Besoin de quelque chose d''authentique pour votre temps libre ?', ''),
(162, 'Chapeau de Cowboy', 'chapeau-de-cowboy', 'Modèle classique, bord rigide durable qui résiste au soleil et à l''humidité.', ''),
(196, 'Chemise avec cravate - large', 'chemise-avec-cravate-large', '', ''),
(197, 'T-Shirt classique bleu - small', 't-shirt-classique-s', '', ''),
(198, 'T-Shirt classique bleu - medium', 't-shirt-classique-m', '', ''),
(199, 'T-Shirt classique bleu - large', 't-shirt-classique-bleu-large', '', '');
...
(301, 'Enfant de variante multiples', 'multi-variante-2'),
(302, 'Enfant de variante multiples', 'multi-variante-3'),
(303, 'Enfant de variante multiples', 'multi-variante-4'),
(304, 'Enfant de variante multiples', 'multi-variante-5'),
(305, 'Enfant de variante multiples', 'multi-variante-6'),
(306, 'Enfant de variante multiples', 'multi-variante-7'),
(307, 'Enfant de variante multiples', 'multi-variante-8'),
(308, 'Enfant de variante multiples', 'multi-variante-9'),
(309, 'Enfant de variante multiples', 'multi-variante-10'),
(310, 'Enfant de variante multiples', 'multi-variante-11'),
(311, 'Enfant de variante multiples', 'multi-variante-12'),
(312, 'Enfant de variante multiples', 'multi-variante-13'),
(313, 'Enfant de variante multiples', 'multi-variante-14'),
(314, 'Enfant de variante multiples', 'multi-variante-15'),
(315, 'Enfant de variante multiples', 'multi-variante-16');
...
( 3,'Vente en gros', 'Acheteurs qui peuvent acheter en gros.', 0,1,1),
( 4,'Niveau Or', 'Acheteurs de niveau Or', 0,1,1);