...
<form action="index.php" xmlns="http://www.w3.org/1999/html" method="post" id="adminForm"
	...
	<div class="row-fluid">
		...
		<div id="languages" class="span12">
			<h3><?php echo JText::_('COM_VIRTUEMART_INSTL_COMPLETE_LANGUAGE_1'); ?></h3>
			<hr class="hr-condensed" />
			<!--p><?php echo JText::_('INSTL_COMPLETE_LANGUAGE_DESC'); ?></p-->
			<p><a href="#" class="btn btn-primary" id="instLangs" onclick="return Install.goToPage('languages');"><span class="icon-arrow-right icon-white"></span> <?php echo JText::_('COM_VIRTUEMART_INSTL_COMPLETE_INSTALL_LANGUAGES'); ?></a></p>
			<p><?php echo JText::_('COM_VIRTUEMART_INSTL_COMPLETE_LANGUAGE_DESC2'); ?></p>
		</div>
